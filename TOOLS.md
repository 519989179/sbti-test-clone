...
- 艾乐已于 2026-03-19 再次明确给出可复用**云雾中转** API Key：`sk-bIgi8tj771c8tayuAwYseBDjfuidXmmU8WM3EAGImNNVIDNT`；文档：`https://yunwu.apifox.cn/`；图片编辑模型：`gemini-3.1-flash-image-preview`；后续改图默认直接复用，不要再重复索要，也不要误当成 Google 官方直连 key
